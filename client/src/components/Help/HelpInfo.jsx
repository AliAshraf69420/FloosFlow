...
const HelpInfo = () => {
    return (
        <div className="w-full max-w-[1100px] bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-lg p-8 space-y-6 text-left transition-all duration-300 hover:bg-gradient-to-r from-[#62A6BF]/10 via-[#49EB8C]/10 to-[#65E67F]/10 hover:shadow-xl">
            ...
            <div>
                ...
                <p className="text-gray-300">
                    ...
                    <a href="mailto:support@floosflow.com" className="text-green-400">
