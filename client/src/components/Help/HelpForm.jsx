...
const HelpForm = () => {
    return (
        <form className="ff-card p-6 space-y-6 flex flex-col  hover:bg-gradient-to-r from-[#62A6BF]/10 via-[#49EB8C]/10 to-[#65E67F]/10   w-full max-w-[1100px]  ">
            ...
            <div className="flex flex-col md:flex-row  sm:flex-row sm:items-center sm:space-x-4 ">
                <label for="message" class="text-lg font-medium w-32 mb-2">Message</label>
            ...
            <div class="flex items-start">
                <button type="submit"
                    class="ff-btn w-full sm:w-40 bg-gradient-to-r from-[#62A6BF] via-[#49EB8C] to-[#65E67F] text-white font-semibold py-3 rounded-xl shadow-md hover:scale-105 transition-transform duration-300">
                    Send message
                </button>
            </div>
