...
const Introduction = () => {
    return (
        <div className="bg-gray-100 dark:bg-white/10 backdrop-blur-xl border border-gray-200 dark:border-white/20 rounded-2xl shadow-lg text-gray-900 dark:text-white hover:text-gray-900 dark:hover:text-white p-6 sm:p-10 flex flex-col space-y-12 sm:space-x-6 w-full max-w-[1100px]">

            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white">
                Manage Your Money the Smart Way with FloosFlow
            </h1>

            <h3 className="text-xl text-[#49EB8C] dark:text-[#ACE6CF] font-semibold">
            ...
            <ol className="list-decimal mt-1 ml-5 text-lg text-gray-700 dark:text-gray-100 space-y-2">
