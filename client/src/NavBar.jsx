...
const NavBar = () => {
  ...
  return (
    <nav
      ...
      className="backdrop-blur-md text-white fixed w-full top-0 z-50 shadow-md"
      role="navigation"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 lg:px-6 flex items-center justify-between h-20 gap-4">
            ...
            {[
              ...
              <li key={label} role="none" className="flex-shrink min-w-[60px]">
                <a
                  role="menuitem"
                  href={href}
                  className="px-2 py-1 rounded-md font-semibold transition-all duration-200 hover:bg-gradient-to-r from-primary via-secondary to-accent hover:text-black block text-center"
                  style={{
        ...
        <div className="hidden md:flex items-center gap-4 flex-shrink-0">
          ...
          >
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 rounded-lg bg-[#2A2A2A]/80 text-gray-100 placeholder-gray-400 
        ...
        <button
            ...
            className="cursor-pointer flex flex-col space-y-1 w-10 h-10 justify-center z-50 relative rounded-md px-4 py-2 font-semibold transition-all duration-200 bg-gradient-to-r from-primary via-secondary to-accent hover:text-black"
        >
            <span
        ...
        <ul
            ...
            className={`${isMenuOpen ? "flex" : "hidden"} flex-col absolute top-16 right-0 w-56 
                    bg-[#1E1E1E]/90 p-4 space-y-2 rounded-md shadow-lg z-40`}
            role="menu"
            aria-label="Mobile Main Menu"
        >
            <li><a href="Home.html" className="block px-4 py-2 rounded-md font-semibold hover:bg-gradient-to-r from-primary via-secondary to-accent hover:text-black">Home</a></li>
            <li><a href="TransactionsHistory.html" className="block px-4 py-2 rounded-md font-semibold hover:bg-gradient-to-r from-primary via-secondary to-accent hover:text-black">Services</a></li>
            <li><a href="Dashboard.html" className="block px-4 py-2 rounded-md font-semibold hover:bg-gradient-to-r from-primary via-secondary to-accent hover:text-black">Dashboard</a></li>
            <li><a href="help.html" className="block px-4 py-2 rounded-md font-semibold hover:bg-gradient-to-r from-primary via-secondary to-accent hover:text-black">Help</a></li>
